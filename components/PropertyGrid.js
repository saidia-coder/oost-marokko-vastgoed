...
function WhatsAppIcon({ size = 15 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
      <rect x="1" y="1" width="30" height="30" rx="7" fill="#25D366" />
      <path fill="#FFFFFF" d="M23.472 18.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.148-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/>
      <path fill="#FFFFFF" d="M16.001 6C10.478 6 6 10.477 6 16c0 1.876.52 3.632 1.42 5.13L6 26l4.998-1.396A9.955 9.955 0 0016.001 26C21.523 26 26 21.523 26 16S21.523 6 16.001 6zm0 18.267a8.24 8.24 0 01-4.437-1.29l-.318-.19-3.03.847.836-2.955-.207-.303a8.238 8.238 0 01-1.31-4.442c0-4.556 3.71-8.267 8.267-8.267 4.556 0 8.267 3.71 8.267 8.267 0 4.556-3.71 8.267-8.267 8.267z"/>
    </svg>
  );
}
...
export default function PropertyGrid({ properties, regions, fetchError }) {
  ...
  return (
    <div style={{ minHeight: "100vh" }}>
      ...
      <section style={{ background: "#C7D9E9", padding: "56px 24px 40px" }}>
        <div style={{ maxWidth: "960px", margin: "0 auto" }}>
          ...
          <h1 style={{ fontFamily: "'Fraunces', serif", fontSize: "44px", fontWeight: 600, lineHeight: 1.1, margin: "0 0 16px", maxWidth: "620px", color: "var(--navy-deep)" }}>
